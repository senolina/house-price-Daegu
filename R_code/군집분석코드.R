...
###train test set 나누기 (이거 해야하나,,?)
#install.packages("caret")
library(caret)
set.seed(1234)

inTrain <- createDataPartition(y = data, p = 0.7, list = F)
...
nc<-NbClust(data, min.nc = 2, max.nc=15, method="kmeans")##해석좀,,,이거 개오래 걸리니까 조심
?NbClust
